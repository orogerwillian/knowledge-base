<template>
    <div class="user-admin">
        <b-form>
            ...
            <b-form-checkbox id="user-admin" v-model="user.admin" class="mt-3 mb-2" v-show="mode === 'save'">
                <label>Administrador?</label>
            </b-form-checkbox>

            <b-row>
                <b-col xs="12">
                    <b-button variant="primary" size="xs" v-if="mode === 'save'" @click="save">Salvar</b-button>
        ...
        methods: {
            ...
            save() {
                ...
                axios[method](`${baseApiUrl}/users${id}`, this.user)
                    .then(() => {
                        this.$toasted.global.defaultRegister()
                        this.reset()
                    })
                    .catch(showError)
            },
